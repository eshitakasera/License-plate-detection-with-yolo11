...
@st.cache_resource
def load_model():
    # [cite_start]PDF report ke hisaab se model path [cite: 280, 285]
    model_path = 'best.pt' 
...
[cite_start]st.write("YOLOv11 Optimized Pipeline | 94.1% Accuracy [cite: 6, 222]")
...
if uploaded_file is not None:
    ...
    # [cite_start]1. Detection Stage [cite: 156]
    [cite_start]results = model.predict(image, conf=0.25) [cite: 127]
    ...
    for box in results[0].boxes:
        ...
        [cite_start]plate_crop = image[y1:y2, x1:x2] [cite: 152, 157]
        st.image(plate_crop, caption="Cropped Plate", width=200)
        
        # [cite_start]EasyOCR Recognition [cite: 46, 66]
